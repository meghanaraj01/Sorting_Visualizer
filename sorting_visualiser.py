...
select_algorithm = StringVar(value='Bubble Sort')  # Default value set
arr = []
...
algomenu = ttk.Combobox(options_frame, textvariable=select_algorithm, values=['Bubble Sort', 'Insertion Sort', 'Selection Sort', 'Merge Sort', 'Quick Sort'], width=20)
